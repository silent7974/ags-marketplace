...
export default function ProcessingOrders() {
  ...
  const totalAmount = processingOrders.reduce(
          ...
          <div key={order._id}>
            ...
            <div className="mt-4 flex flex-col items-center gap-2">
              <button
                ...
                className="w-[200px] h-[43px] rounded-[44px] bg-black flex items-center justify-center"
              >
                {loadingId === order._id ? (
                  <Loader2
                    size={18}
              ...
              <p className="text-[12px] font-inter font-medium text-black/50 text-center max-w-[220px]">
                Your items are ready. Malltiply is assigning a courier for pickup
              </p>
            </div>
          </div>
        ))}
