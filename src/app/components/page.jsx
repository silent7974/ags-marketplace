...
export default function JoinAsSeller() {
  ...
  <div className="bg-gray-900 min-h-screen flex justify-center items-start py-6 px-4 lg:px-8">
    <div className="w-full max-w-sm lg:max-w-3xl bg-gradient-to-b from-[#121212] to-[#0c2e4e] rounded-2xl shadow-2xl overflow-y-auto text-white">
      
            {/* Header */}
            <div className="flex justify-between items-center px-6 pt-4 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="divide-y divide-gray-300 border rounded-xl overflow-hidden">
              ...
              <Link href="https://instagram.com">
                <Image src="/instagram.svg" alt="Instagram" width={20} height={20} className="hover:opacity-80" />
              </Link>
              <Link href="https://facebook.com">
                <Image src="/facebook.svg" alt="Facebook" width={20} height={20} className="hover:opacity-80" />
              </Link>
              <Link href="https://tiktok.com">
                <Image src="/tiktok.svg" alt="TikTok" width={20} height={20} className="hover:opacity-80" />
              </Link>
              <Link href="https://youtube.com">
                <Image src="/youtube.svg" alt="YouTube" width={20} height={20} className="hover:opacity-80" />
              </Link>
            </div>
